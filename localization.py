    ...
    def _load_translations(self) -> Dict[str, Dict[str, str]]:
        ...
        return {
            "en": {
                ...
                "help_ask_desc": "Analyze code and answer questions (read-only, no changes)",
            ...
            "pt-br": {
                ...
                "help_ask_desc": "Analisar código e responder perguntas (somente leitura, sem alterações)",
